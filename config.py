...
WIN_ENG_WEIGHT_HEAD_TO_HEAD = 0.05
WIN_ENG_WEIGHT_VENUE = 0.15
WIN_ENG_WEIGHT_XI_STRENGTH = 0.50
WIN_ENG_WEIGHT_BATTING_ORDER = 0.0
WIN_ENG_WEIGHT_BOWLING_PHASES = 0.0
WIN_ENG_WEIGHT_MATCHUP = 0.0
WIN_ENG_WEIGHT_CONDITIONS = 0.10
# Innings-role fit from team chase vs defend records for the hypothetical toss
WIN_ENG_WEIGHT_TOSS_ROLE = 0.05
# Venue chase prior + dew + night + rain tilt toward the chasing side
WIN_ENG_WEIGHT_CHASE_ENVIRONMENT = 0.0
WIN_ENG_WEIGHT_RECENT_FORM = 0.15
